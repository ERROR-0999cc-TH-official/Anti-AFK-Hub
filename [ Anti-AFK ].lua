...
-- สร้างปุ่มเปิด/ปิด changelogGui ทันทีที่โหลดสคริปต์  
local toggleButtonGui = Instance.new("ScreenGui", PlayerGui)  
...
-- เริ่มแสดงข้อความและสร้าง changelogGui ทีหลัง  
for index, notif in ipairs(notifications) do  
    ...
    -- สร้าง changelogGui หลังข้อความแรกเสร็จ  
    if index == 1 then    
        task.delay(2, function()    
            ...
            changelogGui.Enabled = false -- เริ่มซ่อนไว้    
